...
//        vector(int size = 20) {
//            first = new T* [size];
//            for(int i = 0 ; i < size ; i++)first[i] = nullptr;
//            //first = (T*)(operator new(sizeof(T) * size) );
//            last = -1;
//            endd = size;
//        }
...
//            T ** first2;
//            first2 =  new T*[size * 2];
//            //first2 = (T*)(operator new (sizeof(T) * 2 * size));
...
////        first = new T*[size * 2];
////        for(int i = 0 ; i < size ; i++){
////            first[i] = new T(*first2[i]);
////        }
////        for(int i = 0 ; i < size ; i++){
////            if(first2[i]) delete first2[i];
////        }
////        delete []first2;
//            first = first2;
//            endd = 2 * size;
...
//            if(pos.pos == endd - 1 || last == endd - 1) expand();
...
//            first[pos.pos] = new T(*(first[pos.pos + 1]));
//            for(int i = pos.pos + 1; i < last; i++){
//                first[i] = first[i + 1];
//            }
//            first[last] = nullptr ;
//            last--;
